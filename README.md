<div align="center">
  ...
  <p>
    ...
    <img src="https://img.shields.io/badge/added-ESP32--DevKitC%20%7C%20ESP32--C3-green?style=flat-square" alt="Added ESP32 and ESP32-C3 support" />
  </p>
...
> **This is a fork of [ESP-Claw](https://github.com/espressif/esp-claw) by Espressif Systems**, extended with board support for the classic **ESP32-DevKitC** and **ESP32-C3-DevKitM-1** — both of which have no PSRAM and use 4 MB flash. All original features are preserved for S3/P4 boards.
...
## 🆕 Added Board Support: ESP32-DevKitC & ESP32-C3-DevKitM

This fork adds two new boards to `./application/edge_agent/boards/espressif/`:

| Board folder | Chip | Flash | PSRAM | Onboard LED |
|---|---|---|---|---|
| `esp32_DevKitC` | ESP32 (Xtensa dual-core) | 4 MB | ❌ None | Blue LED GPIO 2 |
| `esp32c3_DevKitM` | ESP32-C3 (RISC-V) | 4 MB | ❌ None | WS2812 RGB GPIO 8 |

A new `partitions_4MB.csv` is included to fit within 4 MB flash.

### Feature comparison

| Feature | ESP32-S3 (original) | ESP32-DevKitC | ESP32-C3-DevKitM |
|---|---|---|---|
| Wi-Fi + LLM agent | ✅ | ✅ | ✅ |
| Telegram / Feishu / QQ | ✅ | ✅ | ✅ |
| MCP client/server | ✅ | ✅ | ✅ |
...
| Emote animations | ✅ | ❌ | ❌ |
| OTA dual-slot | ✅ | ❌ | ❌ |
| LCD / Display | ✅ | ⚠️ optional | ⚠️ optional |
