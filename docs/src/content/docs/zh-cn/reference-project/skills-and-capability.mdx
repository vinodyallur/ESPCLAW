...
2. 将 `cap_groups` 中列出的 Capability Group 设为 session 可见（LLM 获得工具）。
...
<LinkCard href="@lang/reference-core/claw-skill" title="claw_skill" description="Skills 目录结构、skills_list.json 格式与 session 激活状态的底层实现" />
